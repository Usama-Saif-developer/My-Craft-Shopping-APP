...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AddressesAdapter.ViewHolder holder, int position) {
        ...
        holder.setDataforaddress(name, city, pincode, selected, position, mobileNo, alternateMobileNo, flatNo, locality, state, landmark);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setDataforaddress(String username, String city, String userpincode, Boolean selected, int position, String mobileNo, String alternateMobileNo, String flatNo, String locality, String state, String landmark) {
            ...
            if (MODE == SELECT_ADDRESS) {
                ...
                optionContainer.getChildAt(0).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //////Edit address
                        Intent addAddressIntent = new Intent(itemView.getContext(), AddressActivity.class);
