...
public class PaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID = "MC20646";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Malik Usama: price_before : " + price);


        String[] values = price.split("\\.");
        price = values[0];
        price = price + " ";
        System.out.println("Malik Usama: price : " + price);

        Date Date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddkkmmss");
        String DateString = dateFormat.format(Date);
        System.out.println("Malik Usama: DateString : " + DateString);
        ...
        System.out.println("Malik Usama: expiryDateString : " + expiryDateString);

        String TransactionIdString = "T" + DateString;
        System.out.println("Malik Usama: TransactionID : " + TransactionIdString);
        ...
        System.out.println("Malik Usama: postData : " + postData);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            if (url.equals(paymentReturnUrl)) {
                System.out.println("Malik Usama: return url cancelling");
                view.stopLoading();
                return;
            }
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            ...
            System.out.println("Malik Usama: Url:" + url + " form data " + formData);
            if (url.equals(paymentReturnUrl)) {
                String[] values = formData.split("&");
                for (String pair : values) {
                    String[] nameValue = pair.split("=");
                    if (nameValue.length == 2) {
                        System.out.println("Malik Usama: Name:" + nameValue[0] + " value:" + nameValue[1]);
