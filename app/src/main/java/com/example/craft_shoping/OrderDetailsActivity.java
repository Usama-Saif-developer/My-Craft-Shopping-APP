...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        title = findViewById(R.id.product_title_at_wishlist);
        price = findViewById(R.id.product_price_at_wishlist);
        quantity = findViewById(R.id.product_quantity);
        productImage = findViewById(R.id.product_image_at_wishlist);
        ...
        P_S_progress = findViewById(R.id.packed_shipping_progressbar);
        S_D_progress = findViewById(R.id.shipping_delivered_progressbar);
        ...
        deliveredDate = findViewById(R.id.delibered_date);
        ...
        cancelorderButton = findViewById(R.id.cancel_order_btn);
        ...
        String quantityvalue = String.valueOf(model.getProductQuantity());
        quantity.setText("Qty :" + quantityvalue);
        ...
        switch (model.getOrderStatus()) {
            case "Ordered":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_200)));
            ...
            case "Cancelled":
                if (model.getPackedDate().after(model.getOrderedDate())) {
                    if (model.getShippedDate().after(model.getPackedDate())) {
                        ...
                        shippedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_200)));
                        shippedDate.setText(String.valueOf(simpleDateFormat.format(model.getShippedDate())));
                        deliveredIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_700)));
                        ...
                        packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_200)));
                        packedDate.setText(String.valueOf(simpleDateFormat.format(model.getPackedDate())));
                        shippedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_700)));
                    ...
                    packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.teal_700)));
        ...
        if (model.isCancellationRequested()) {
            ...
            cancelorderButton.setTextColor(getResources().getColor(R.color.teal_700));
        ...
        if (model.getDeliveryPrice().equals("FREE")) {
            ...
            totalAmount.setText("Rs." + totalItemsPrice.getText() + "/-");
        } else if (model.getDeliveryPrice().equals("") || model.getDeliveryPrice() == null) {
            deliveryPrice.setText(model.getDeliveryPrice());
            totalAmount.setText("Rs." + totalItemsPrice.getText() + "/-");
        } else {
